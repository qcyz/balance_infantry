...
Graph_Data diff_ang,pose,path1,path2;
...
static void print_chassis_path(void)
{
	Line_Draw(&path1, "004", UI_Graph_Change, 3,UI_Color_Pink, 3, 1072, 543, 1456, 0);
	My_Graph_Refresh(&path1);                                  
	Line_Draw(&path2, "005", UI_Graph_Change, 3, UI_Color_Pink, 3, 464, 0, 848, 543);
	My_Graph_Refresh(&path2);
}